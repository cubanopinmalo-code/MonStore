...
- La liberación se ejecuta sola mediante una tarea programada en el servidor: no depende de que el administrador abra el panel, de un botón, ni de que vendedor o comprador estén conectados. La tarea busca las ventas cuya hora de liberación ya pasó y las procesa una por una, resistiendo reinicios, cortes de conexión y ejecuciones duplicadas. Se revisará cada 15 minutos: es lo que hace que el pago llegue con un retraso máximo de 15 minutos sobre las 8 horas; una revisión menos frecuente reduciría el coste de mantener la base activa, pero retrasaría más el pago al vendedor.
