...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MONSTORE — Recargas de videojuegos en CUP" },
      {
        name: "description",
        content:
          "MONSTORE: recargas de videojuegos, wallet en CUP y comercio de cuentas para la comunidad gamer cubana.",
      },
      { property: "og:site_name", content: "MONSTORE" },
